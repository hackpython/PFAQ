...
## 2. 问题：Tensor holds the wrong type
...
## 3.问题：Tensor not initialized yet when Tensor::type() is called.
...
## 6.问题：Data Type mismatch: 5 to 2
...
## 7.问题： Enforce failed. Expected x_dims[i + axis] == y_dims[i], but received x_dims[i + axis]:800 != y_dims[i]:200.
