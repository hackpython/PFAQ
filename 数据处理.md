...
## `待审核`5.问题：Fluid版本中中数据格式与v2版本接口有区别？
...
## `待审核`6.问题：如何使用numpy数组对Variable赋值？
...
## `待审核`9.问题：Fluid如何在输入层定义batch_size大小？
...
## `待审核`10.问题：Fluid版Paddle多机训练时，batch_size大小实际是多少？
...
## `待审核`12.在Paddle中如何创建并使用自己创建的reader数据读入者
