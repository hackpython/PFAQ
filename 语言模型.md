...
Traceback (most recent call last):
  ...
  File "train.py", line 182, in train
    optimizer.minimize(loss)
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/optimizer.py", line 263, in minimize
    params_grads = append_gradient_clip_ops(params_grads)
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/clip.py", line 353, in append_gradient_clip_ops
    res.append(clip_attr._create_operators(param=p, grad=g))
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/clip.py", line 283, in _create_operators
    group_norm_var = layers.sums(input=self.context[self.group_name])
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/layers/tensor.py", line 225, in sums
    dtype=helper.input_dtype())
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/layer_helper.py", line 109, in input_dtype
    (dtype, each.dtype))
...
Traceback (most recent call last):
  ...
  File "train.py", line 165, in train
    rnn_model=rnn_model)
  File "/Users/jizhi/Desktop/Paddle/models/fluid/PaddleNLP/language_model/lstm/lm_model.py", line 270, in lm_model
    x_emb, len=num_steps, init_hidden=init_hidden, init_cell=init_cell)
  File "/Users/jizhi/Desktop/Paddle/models/fluid/PaddleNLP/language_model/lstm/lm_model.py", line 224, in encoder_static
    res.append(layers.reshape(input, shape=[1, 1, hidden_size]))
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/layers/nn.py", line 4979, in reshape
    "XShape": x_shape})
...
## `待审核`9.问题：运行github中GRU的models报错

+ 问题描述：使用models项目下的GRU代码报错

+ 报错输出：

```
python train.py
Cache file /Users/jizhi/.cache/paddle/dataset/imikolov/simple-examples.tgz not found, downloading http://ww[==================================================]
Traceback (most recent call last):
...
paddle.fluid.core.EnforceNotMet: Cannot run operator on place CUDAPlace(0) at [/Users/paddle/minqiyang/Paddle/paddle/fluid/framework/operator.cc:146]
PaddlePaddle Call Stacks:
0          0x1166e3a68p paddle::platform::EnforceNotMet::EnforceNotMet(std::exception_ptr, char const*, int) + 760
1          0x1175081f9p paddle::framework::OperatorBase::Run(paddle::framework::Scope const&, boost::variant<paddle::platform::CUDAPlace, paddle::platform::CPUPlace, paddle::platform::CUDAPinnedPlace, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_, boost::detail::variant::void_> const&) + 761
2          0x1167b13a6p paddle::framework::Executor::RunPreparedContext(paddle::framework::ExecutorPrepareContext*, paddle::framework::Scope*, bool, bool, bool) + 390
3          0x1167b0dd3p paddle::framework::Executor::Run(paddle::framework::ProgramDesc const&, paddle::framework::Scope*, int, bool, bool) + 163
4          0x116717837p void pybind11::cpp_function::initialize<paddle::pybind::pybind11_init()::$_64, void, paddle::framework::Executor&, paddle::framework::ProgramDesc const&, paddle::framework::Scope*, int, bool, bool, pybind11::name, pybind11::is_method, pybind11::sibling>(paddle::pybind::pybind11_init()::$_64&&, void (*)(paddle::framework::Executor&, paddle::framework::ProgramDesc const&, paddle::framework::Scope*, int, bool, bool), pybind11::name const&, pybind11::is_method const&, pybind11::sibling const&)::'lambda'(pybind11::detail::function_call&)::__invoke(pybind11::detail::function_call&) + 135
5          0x1166ee3aap pybind11::cpp_function::dispatcher(_object*, _object*, _object*) + 5786
6          0x10986359fp PyCFunction_Call + 127
7          0x10992e7e7p PyEval_EvalFrameEx + 33207
8          0x109924fafp _PyEval_EvalCodeWithName + 335
9          0x10992b2a7p PyEval_EvalFrameEx + 19575
10         0x109924fafp _PyEval_EvalCodeWithName + 335
11         0x10992b2a7p PyEval_EvalFrameEx + 19575
12         0x10992afb8p PyEval_EvalFrameEx + 18824
13         0x109924fafp _PyEval_EvalCodeWithName + 335
14         0x109977758p PyRun_FileExFlags + 248
15         0x109976eeep PyRun_SimpleFileExFlags + 382
16         0x10999bd86p Py_Main + 3622
17         0x1097dd861p main + 497
18      0x7fff5f4da015p start + 1
```

+ 问题分析：

从报错输出栈中，发现`Cannot run operator on place CUDAPlace(0)`，通常是运行设备上没有GPU造成的问题，如果环境中没有GPU则使用CPU运行则可
...
Traceback (most recent call last):
  ...
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/parallel_executor.py", line 98, in __init__
    for i in six.moves.range(core.get_cuda_device_count()):
AttributeError: module 'paddle.fluid.core' has no attribute 'get_cuda_device_count'
```
...
从报错输出栈中，看出报错原因为paddle.fluid.core中没有get_cuda_device_count属性，该问题通常是运行环境中缺失GPU设备造成的。
...
## `待审核`11.问题：使用Paddle Fluid版运行GRU模型有问题，模型从models中获取

+ 问题描述：使用Fluid运行GPU模型报错，GPU从官方models中直接获取的
...
*** Aborted at 1547802001 (unix time) try "date -d @1547802001" if you are using GNU date ***
PC: @                0x0 (unknown)
*** SIGSEGV (@0x0) received by PID 84323 (TID 0x7fff98009380) stack trace: ***
    @     0x7fff5f7e8f5a _sigtramp
[1]    84323 segmentation fault  python train.py
```
...
## `待审核`12.问题:通过Fluid编写语言模型时，出现该问题

+ 问题描述：通过Fluid编写语言模型时，出现`list index out of range`
...
从报错输出来看，报错原因其实很明显，就是从list中获取值时，超出的编辑，从相关来看，问题在于训练时没有指定返回值，但却获取并使用了返回值
...
## `待审核`13.问题：使用Fluid编写自动生成的文章的模型时，报错

+ 问题描述：使用Fluid编写自动生成文章的模型，其中使用了GRU与LSTM，运行模型时报错
...
Traceback (most recent call last):
  ...
  File "train.py", line 43, in network
    is_sparse=True)
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/layers/nn.py", line 330, in embedding
  ...
  File "/Users/jizhi/anaconda3/envs/paddle/lib/python3.5/site-packages/paddle/fluid/framework.py", line 656, in __init__
    self.desc.infer_shape(self.block.desc)
paddle.fluid.core.EnforceNotMet: Enforce failed. Expected ids_dims[ids_rank - 1] == 1, but received ids_dims[ids_rank - 1]:3 != 1:1.
The last dimension of the 'Ids' tensor must be 1. at [/Users/paddle/minqiyang/Paddle/paddle/fluid/operators/lookup_table_op.cc:39]
PaddlePaddle Call Stacks:
0          0x11c3bfa68p paddle::platform::EnforceNotMet::EnforceNotMet(std::exception_ptr, char const*, int) + 760
1          0x11cbbd5d0p paddle::operators::LookupTableOp::InferShape(paddle::framework::InferShapeContext*) const + 1872
2          0x11c47ce68p paddle::framework::OpDesc::InferShape(paddle::framework::BlockDesc const&) const + 1496
3          0x11c446479p _ZZN8pybind1112cpp_function10initializeIZNS0_C1IvN6paddle9framework6OpDescEJRKNS4_9BlockDescEEJNS_4nameENS_9is_methodENS_7siblingEEEEMT0_KFT_DpT1_EDpRKT2_EUlPKS5_S8_E_vJSN_S8_EJS9_SA_SB_EEEvOSD_PFSC_SF_ESL_ENKUlRNS_6detail13function_callEE_clESU_ + 185
4          0x11c3ca3aap pybind11::cpp_function::dispatcher(_object*, _object*, _object*) + 5786
5          0x10f63d59fp PyCFunction_Call + 127
6          0x10f7087e7p PyEval_EvalFrameEx + 33207
7          0x10f6fefafp _PyEval_EvalCodeWithName + 335
8          0x10f60a6aap function_call + 106
9          0x10f5c6b35p PyObject_Call + 69
10         0x10f5e9694p method_call + 148
11         0x10f5c6b35p PyObject_Call + 69
12         0x10f663415p slot_tp_init + 117
13         0x10f667ac1p type_call + 209
14         0x10f5c6b35p PyObject_Call + 69
15         0x10f705c9bp PyEval_EvalFrameEx + 22123
16         0x10f6fefafp _PyEval_EvalCodeWithName + 335
17         0x10f60a6aap function_call + 106
18         0x10f5c6b35p PyObject_Call + 69
19         0x10f705c9bp PyEval_EvalFrameEx + 22123
20         0x10f6fefafp _PyEval_EvalCodeWithName + 335
21         0x10f7052a7p PyEval_EvalFrameEx + 19575
22         0x10f6fefafp _PyEval_EvalCodeWithName + 335
23         0x10f7052a7p PyEval_EvalFrameEx + 19575
24         0x10f704fb8p PyEval_EvalFrameEx + 18824
25         0x10f6fefafp _PyEval_EvalCodeWithName + 335
26         0x10f7052a7p PyEval_EvalFrameEx + 19575
27         0x10f704fb8p PyEval_EvalFrameEx + 18824
28         0x10f6fefafp _PyEval_EvalCodeWithName + 335
29         0x10f751758p PyRun_FileExFlags + 248
30         0x10f750eeep PyRun_SimpleFileExFlags + 382
31         0x10f775d86p Py_Main + 3622
32         0x10f5b7861p main + 497
33      0x7fff5f4da015p start + 1
```
...
src_wordseq = fluid.layers.data(
    name="src_wordseq", shape=[2,3], dtype="int64", lod_level=1)
dst_wordseq = fluid.layers.data(
    name="dst_wordseq", shape=[2,3], dtype="int64", lod_level=1)
```

+ 问题描述：

输出的错误栈中存在`Enforce failed. Expected ids_dims[ids_rank - 1] == 1`，造成该错误的原因通常是网络结构中某个节点的结构有问题。
...
## `待审核`14.问题：使用Fluid实现最简单的gru时，出现下面错误

+ 问题描述：根据教程通过Fluid实现gru，在运行时，报错
...
Traceback (most recent call last):
  ...
  File "train.py", line 102, in train
    init_low_bound, init_high_bound)
  File "train.py", line 58, in network
    learning_rate=gru_lr_x))
TypeError: dynamic_gru() missing 1 required positional argument: 'input'
```

+ 相关代码：

```python
h0 = fluid.layers.dynamic_gru(
        size=hid_size,
...
错误输出中，提示了明显的原因`dynamic_gru() missing 1 required positional argument: 'input'`，解决方法只需为dynamic_gru中添加输入则可
